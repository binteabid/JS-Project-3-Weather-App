...
document.write('<nav class="navbar" >     <div class="container-fluid">         <a class="navbar-brand" href="#" >            <img src="./assets/images/logo.png" alt="Logo" width="200" height="140"                 class="d-inline-block align-text-top"></a>  </div></nav>')
...
// console.log("The current weather of "+cityName+" is " +weatherInCelsius+ " °C.");
// document.write("<br> The current weather of "+cityName+" is " +weatherInCelsius+ " °C.")
