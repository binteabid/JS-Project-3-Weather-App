...
document.write('<nav class="navbar" >     <div class="container-fluid">         <a class="navbar-brand" href="#" >            <img src="./assets/images/logo.png" alt="Logo" width="200" height="130"                 class="d-inline-block align-text-top"></a>  </div></nav>')
